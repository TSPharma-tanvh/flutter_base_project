...
import 'package:flutter_base_project/note_app/controller/notes_controller.dart';
import 'package:flutter_base_project/note_app/dto/notes_dto.dart';
...
class _EditNoteState extends State<EditNote> {
  ...
  Widget build(BuildContext context) {
    args = ModalRoute.of(context)?.settings.arguments as EditNoteArgs;
    return Scaffold(
