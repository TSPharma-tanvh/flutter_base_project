...
List<CollectionListModel> collectionListModelFromJson(String str) =>
    new List<CollectionListModel>.from(
  ...
  factory CollectionListModel.fromJson(Map<String, dynamic> json) {
    return CollectionListModel(
      ...
      links: json["links"] != null
          ? CollectionListModelLinks.fromJson(json["links"])
          : null,
...
//             ? null
//             : new List<dynamic>.from(json["categories"].map((x) => x)),
...
class CoverPhoto {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "current_user_collections": currentUserCollections != null
          ? List<dynamic>.from(currentUserCollections!)
          : null,
      "user": user?.toJson(),
    };
  }
...
//   factory CollectionListModelLinks.fromJson(Map<String, dynamic> json) =>
//       new CollectionListModelLinks(
//         self: json["self"] == null ? null : json["self"],
//         html: json["html"] == null ? null : json["html"],
//         photos: json["photos"] == null ? null : json["photos"],
...
class PreviewPhoto {
  ...
  PreviewPhoto({this.id, this.urls});
