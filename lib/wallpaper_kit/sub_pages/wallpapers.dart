...
import 'package:flutter_base_project/wallpaper_kit/models/images_list_model.dart';
import 'package:flutter_base_project/wallpaper_kit/services/image_service.dart';
...
Widget latestWalls(context) {
  return Container(
    ...
    child: FutureBuilder<ImagesListModel?>(
      future: getImages(type: 'black cars'),
      builder:
          (BuildContext context, AsyncSnapshot<ImagesListModel?> snapshot) {
